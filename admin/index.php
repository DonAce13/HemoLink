...
<body>
    ...
    <div class="menu" id="sidebar">
        <!-- Profile section is commented out for now -->
        <!--
    ...
    <div class="menu-container">
        <!-- Menu Buttons -->
        <div class="menu-btn menu-icon-dashbord menu-active menu-icon-dashbord-active">
            <a href="index.php" class="non-style-link-menu non-style-link-menu-active">
                <p class="menu-text">Dashboard</p>
            </a>
        </div>
        <div class="menu-btn menu-icon-doctor">
            <a href="doctors.php" class="non-style-link-menu">
                <p class="menu-text">Doctors</p>
            </a>
        </div>
        <div class="menu-btn menu-icon-schedule">
            <a href="schedule.php" class="non-style-link-menu">
                <p class="menu-text">Schedule</p>
            </a>
        </div>
        <div class="menu-btn menu-icon-appointment">
            <a href="appointment.php" class="non-style-link-menu">
                <p class="menu-text">Appointment</p>
            </a>
        </div>
        <div class="menu-btn menu-icon-patient">
            <a href="patient.php" class="non-style-link-menu">
                <p class="menu-text">Patient</p>
            </a>
        </div>
    </div>
</div>
